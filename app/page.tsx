      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="#templates" className="text-sm opacity-80 hover:opacity-100 transition-opacity">
              Templates
            </Link>
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-md glass-effect border border-white/20">
              <DialogHeader>
                <DialogTitle className="text-center text-xl font-bold mb-2">Welcome Back</DialogTitle>
              </DialogHeader>
              <Tabs defaultValue="signin" className="w-full">
                ...
                <TabsContent value="signin" className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="email" placeholder="your@email.com" className="bg-white/5" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="password">Password</Label>
                    <Input id="password" type="password" placeholder="••••••••" className="bg-white/5" />
                  </div>
                ...
                <TabsContent value="signup" className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="signup-name" placeholder="John Doe" className="bg-white/5" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="signup-email">Email</Label>
                    <Input id="signup-email" placeholder="your@email.com" className="bg-white/5" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="signup-password">Password</Label>
                    <Input id="signup-password" type="password" placeholder="••••••••" className="bg-white/5" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="confirm-password">Confirm Password</Label>
                    <Input id="confirm-password" type="password" placeholder="••••••••" className="bg-white/5" />
                  </div>
                  <Button className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600">
                    Create Account
                  </Button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          {...register("skills")}
                        />
                        {errors.skills && <p className="text-red-500 text-sm mt-1">{String(errors.skills.message)}</p>}
                      </div>
                    </div>
    ...
    portfolioOptions.map((portfolio) => (
      ...
      <section className="py-16 md:py-24" ref={featuredRef}>
        <div className="container mx-auto px-4">
          ...
          >
            {[1, 2, 3].map((id) => (
              <motion.div key={id} variants={itemVariants} className="glass-effect rounded-xl overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <p className="text-sm opacity-70 mb-4">
                    A professional showcase of design work with case studies and process insights.
                  </p>
                  <Link
                    href={`/portfolio/${id}`}
          ...
          >
            <motion.div variants={itemVariants} className="glass-effect p-6 rounded-xl">
              ...
              <p className="italic opacity-90">
                "I landed three interviews within a week of sharing my new portfolio. The templates are professional and
                easy to customize."
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="glass-effect p-6 rounded-xl">
              ...
              <p className="italic opacity-90">
                "As a developer, I was skeptical about a no-code portfolio builder, but the clean code and performance
                impressed me. My clients love it!"
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="glass-effect p-6 rounded-xl">
              ...
              <p className="italic opacity-90">
                "The animated elements and responsive design make my work stand out. I've received so many compliments
                on my new portfolio."
              </p>
            </motion.div>
          </motion.div>
      ...
      <section id="team" className="py-16 md:py-24 border-t border-white/10">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { name: "Shreeteja", role: "Full Stack Developer", color: "from-blue-500/30 to-cyan-500/30" },
              { name: "Akash", role: "UI/UX Designer", color: "from-purple-500/30 to-pink-500/30" },
              { name: "Dhanush", role: "Backend Engineer", color: "from-green-500/30 to-teal-500/30" },
              { name: "Sreeja", role: "Project Manager", color: "from-orange-500/30 to-red-500/30" },
            ].map((member, index) => (
              <motion.div
                key={member.name}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg mb-8 opacity-90">
              Create your professional portfolio in minutes and share it with the world
            </p>
            <Button
